...
class TwitterApp {
    ...
    public function follow($names = array()) {
        foreach($names as $key => $value) {
            $this->tmhOAuth->request('POST', $this->tmhOAuth->url('1.1/friendships/create'), array('screen_name' => $value));
        }
    ...
    public function getList() {
        $this->tmhOAuth->request('GET', $this->tmhOAuth->url('1.1/lists/members'), array('slug' => 'LISTNAME', 'owner_screen_name' => 'USERNAME'));
    ...
    public function rateLimitStatus() {
        return $this->tmhOAuth->request('GET', $this->tmhOAuth->url('1.1/application/rate_limit_status'), null);
    }
